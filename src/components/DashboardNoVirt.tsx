...
import { DataTableNoVirt } from "./DataTableNoVirt";
import {
  Loader2,
  TrendingUp,
  MapPin,
      ...
      <div className="gradient-primary text-white py-12 px-4 mb-8 shadow-2xl">
        <div className="container mx-auto">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-4xl font-bold">버스 혼잡도 분석 대시보드 (Non-Virtualization)</h1>
          </div>
          <p className="text-blue-100 text-lg ml-13">가상화 미적용 성능 테스트 버전</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="card-modern p-6 animate-scale-in">
            ...
            <DataTableNoVirt rows={filteredData} maxHeight={500} />
          </div>
        </div>
      </div>
    </div>
